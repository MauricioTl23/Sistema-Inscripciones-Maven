...
public class ExistingStudentController implements Initializable, MainControllerAware, DataReceiver {
    ...
    private final ObservableList<Guardian> listaTutores = FXCollections.observableArrayList();
    private FilteredList<Guardian> filteredTutores;
    private final ObservableList<Course> listaCursos = FXCollections.observableArrayList();
